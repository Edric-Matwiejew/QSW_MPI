...
def plot_times(graph_type, savename):
    ...
    plt.plot(df_MPI_max[df_MPI_max["name"].str.startswith(graph_type)]["SO_nnz"], df_MPI_max[df_MPI_max["name"].str.startswith(graph_type)]["total_time"],'.', label = "QSW\_MPI (" + str(max_comm) + ")")
