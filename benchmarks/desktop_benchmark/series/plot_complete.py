...
diffs_min_real = natsorted(glob('QSW_MPI_Results/*min_real_complete*.npy'))
diffs_min_imag = natsorted(glob('QSW_MPI_Results/*min_imag_complete*.npy'))
...
plt.savefig("plots/delta_real_complete.jpg", dpi = 300)
plt.clf()
...
plt.xlabel("time step")
plt.ylim(-1e-13,1e-13)
plt.savefig("plots/delta_imag_complete.jpg", dpi = 300)
plt.clf()
...
plt.legend()
plt.savefig("plots/step_vs_series_times_complete.jpg", dpi = 300)
plt.close()
