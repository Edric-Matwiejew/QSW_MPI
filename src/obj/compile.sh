...
#python -m numpy.f2py --f90exec="mpifort" --f90flags="-fbounds-check -ffpe-trap=invalid" -c fMPI.pyf ../sparse.f90 ../one_norms.f90 ../expm.f90 ../operators.f90 -m fMPI fMPI.f90
#python -m numpy.f2py -h --overwrite-signature foperators.pyf -m foperators foperators.f90
#python -m numpy.f2py --f90exec="mpifort" --f90flags="-fbounds-check -ffpe-trap=invalid" -c ../sparse.f90 ../operators.f90  -m foperators foperators.f90
...
#
#python3 -m numpy.f2py --f90exec="mpifort" --f90flags="-Og -g -fbounds-check -fcheck=all -fbacktrace -ffpe-trap=invalid" -lgomp -c fMPI.pyf ../sparse.f90 ../one_norms.f90 ../expm.f90 ../operators.f90 -m fMPI fMPI.f90
#python3 -m numpy.f2py --f90exec="mpifort" --f90flags="-g -fbounds-check" -lgomp  -c -m fMPI fMPI.f90
#python3 -m numpy.f2py --f90exec="mpifort" --f90flags="-Og -g -fbounds-check -fcheck=all -fbacktrace -ffpe-trap=invalid" -lgomp -c foperators.pyf ../sparse.f90 ../operators.f90 -m foperators foperators.f90
#
rm ../../freeqsw/*.so
cp *.so ../../freeqsw/
